---
title: "Synthea Machine Learning Analysis for Day Zero Data"
...
```
R Script to Predict ICU Admission Based on Day Zero Biomarker Levels
...
Loading Dataset
```{r data_load}
dataset <- read.csv("day_0_levels.csv", header=TRUE)
